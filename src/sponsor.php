<section id="sponsor">
    ...
    <div class="container">
        ...
        <!--<br>-->
        <div class="box"><img src="/res/selo_criativo.png" alt="Selo Criativo" class="sponsor"></div>
        <div class="box"><img src="/res/juicy.png" alt="Juicy Santos" class="sponsor"></div>
        <div class="box"><img src="/res/arcano.png" alt="" class="sponsor"></div>
