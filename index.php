...
<body>
    ...
    <section id="home">
        ...
        <div class="social">
            <a href="https://www.instagram.com/encontrodecriadores/" target="_blank">
                <img src="/res/instagram.svg"></img>
            </a>
            <a href="https://www.facebook.com/encontrodecriadores/" target="_blank">
    ...
    <section id="sobre">
        <h1>Qual é?</h1>
        <div class="container">
            <p>Somos uma plataforma multicultural de criatividade que através de eventos e ações, que visa fomentar as expressões criativas como um todo, assim como valorizar a experiência de vida e a troca humana em todas suas vertentes!</p>
            ...
            <div class="flex">
                ...
                <a href="https://www.instagram.com/felipeseguro/" target="_blank">
                    <div class="person">
                        ...
                        <ul>
                            <li>Publicitário</li>
                            <li>Produtor Curta Santos</li>
                            <li>Strategic Planner em</li>
                            <li>Selo Criativo</li>
                        </ul>
                    </div>
                </a>
                ...
                <a href="https://www.facebook.com/profile.php?id=100002181630064" target="_blank">
                    <div class="person">
                        ...
                        <ul>
                            ...
                            <li>Sócio ADM em Selo Criativo</li>
                            <li class="ghost">_</li>
                        </ul>
                    </div>
                </a>
    ...
    <section id="categories">
        ...
        <div class="container">
            <div class="flex">
                <div class="box">
                    <div class="img">
                        <img src="/res/arte.png" alt="Arte" class="icon">
                    </div>
                    <p class="title">Arte</p>
                </div>
                <div class="box">
                    <div class="img">
                        <img src="/res/gastro.png" alt="Gastronomia" class="icon">
                    </div>
                    <p class="title">Gastronomia</p>
                </div>
                <div class="box">
                    <div class="img">
                        <img src="/res/moda.png" alt="Moda" class="icon">
                    </div>
            ...
            <div class="flex">
                <div class="box">
                    <div class="img">
                        <img src="/res/musica.png" alt="Música" class="icon">
                    </div>
                    <p class="title">Música</p>
                </div>
                <div class="box">
                    <div class="img">
                        <img src="/res/escrita.png" alt="Oficinas" class="icon">
                    </div>
                    <p class="title">Oficinas</p>
                </div>
                <div class="box">
                    <div class="img">
                        <img src="/res/fotografia.png" alt="Fotografia" class="icon">
                    </div>
